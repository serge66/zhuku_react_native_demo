...
import {Image, StyleSheet, View, Text, ScrollView, Dimensions, TouchableOpacity} from "react-native";
                ...
                <ScrollView
                    ...
                    <View
                        ...
                        <View style={[styles.top]}>
                            <View>
                                <Image style={styles.header}
                                       source={require('../assets/img/default_head.png')}></Image>
                            </View>
                            <View style={styles.info}>
                                <View style={styles.name_post}>
                                    <View><Text style={styles.name}>李胜杰</Text></View>
                                    <View><Text style={styles.post}>系统管理员</Text></View>
                                </View>
                                <View style={styles.company_layout}>
                                    <Text style={styles.company}>湖南筑库网信息技术有限公司（测试环境）</Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={styles.bottom}>
                            <Text style={[styles.bottom_info]}>全国服务热线:400-777-3177</Text>
                        </View>
                    </View>
                </ScrollView>
            </View>
